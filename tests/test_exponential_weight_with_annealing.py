...
def make_simple_game():
    ...
    game = GameEngine(setup, algorithm="exponential_weight_with_annealing", max_iter=1e4)
    game.set_initial_action_profile(np.array([0, 0]))
    
    return game

def test_exponential_weight_with_annealing_algorithm():
...
def test_exponential_weight_with_annealing_algorithm_convergence():
