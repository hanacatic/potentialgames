...
def beta_experiments(delta = 0.25):
    ...
    mean_potential_history = np.zeros((5, game.max_iter))
    betas = np.arange(beta_t/2, beta_t + beta_t/8.0, beta_t/8.0)
    betas_labels = [ r'$\frac{\beta_T}{2}$', r'$\frac{5\beta_T}{8}$', r'$\frac{6\beta_T}{8}$', r'$\frac{7\beta_T}{8}$', r'$\beta_T$']
    ...
    plot_lines(mean_potential_history, betas_labels, title)
